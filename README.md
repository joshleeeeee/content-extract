...
[![Version](https://img.shields.io/badge/version-v1.7.0-blue.svg)](https://github.com/joshleeeeee/content-extract)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-Chrome%20%7C%20Edge%20%7C%20Lark%20%7C%20JD%20%7C%20Taobao-lightgrey.svg)](https://github.com/joshleeeeee/content-extract)

一款极致小巧、功能强大的在线内容转换与导出工具。支持将飞书/Lark 等文档（包括受保护无法复制的文档）以及京东/淘宝/天猫商品评论，一键转换为 Markdown、富文本、PDF、CSV 或 JSON，并提供强大的批量任务与下载中心能力。
...
- **🤖 多平台适配**: 完美支持 **飞书/Lark** 文档、**BOSS 直聘** 职位信息提取，以及 **京东/淘宝/天猫** 商品评论抓取。
- **🛍️ 评论提取**: 新增电商评论抓取流程，支持评论区自动展开与前台滚动增量抓取，输出 **Markdown/HTML/PDF/CSV/JSON**。
